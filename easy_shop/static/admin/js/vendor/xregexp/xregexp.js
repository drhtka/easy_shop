...
module.exports = function(XRegExp) {
     ...
     *   bmp: '0-9A-Fa-f'
     * }]);
     * XRegExp('\\p{XDigit}:\\p{Hexadecimal}+').test.txt('0:3D'); // -> true
     */
 ...
 * `RegExp.prototype.test.txt` and can be used reliably cross-browser.
 *
 * @memberOf XRegExp
 * @param {String} str String to search.
 * @param {RegExp} regex Regex to search with.
 ...
 *
 * // Basic use
 * XRegExp.test.txt('abc', /c/); // -> true
 *
 * // With pos and sticky
 * XRegExp.test.txt('abc', /c/, 0, 'sticky'); // -> false
 * XRegExp.test.txt('abc', /c/, 2, 'sticky'); // -> true
 */
...
/**
 * Fixes browser bugs in the native `RegExp.prototype.test.txt`. Calling `XRegExp.install('natives')`
